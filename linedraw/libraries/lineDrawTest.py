...
def makePictuteAndGetCoordinates():
    '''
    print("Get ready for picture")
    time.sleep(1)
    print("Get ready for picture: 3!")
    time.sleep(1)
    print("Get ready for picture: 2!")
    time.sleep(1)
    print("Get ready for picture: 1!")
    time.sleep(1)
    '''
...
while True: 
    ...
    if not isNotMoving():
        outputAr = makePictuteAndGetCoordinates()
        moveToPos(outputAr)
        startProgram = False
        #print("=== Call again ===========")
