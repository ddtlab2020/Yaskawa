...
def printPDF(filepath):
    ...
    win32api.ShellExecute(0, "print", filepath, '/d:"%s"' % currentprinter, ".", 0)
...
def takePicture():
    ...
    originalSVG = svgutils.compose.SVG("C:/Users/300ju/Desktop/DxPackage/linedraw/output/merged.svg")
    originalSVG.rotate(90)
    originalSVG.move(600, 0)
 
    figure = svgutils.compose.Figure(640, 500, originalSVG)
    figure.save("C:/Users/300ju/Desktop/DxPackage/linedraw/output/merged2.svg")

    saveSVGToPDF("C:/Users/300ju/Desktop/DxPackage/linedraw/output/merged2.svg")
  
    #printPDF("C:/Users/300ju/Desktop/DxPackage/linedraw/output/test.pdf")

    #svg_image_display = tksvg.SvgImage(file="C:/Users/300ju/Desktop/DxPackage/linedraw/output/out.svg")
    svg_image_display = tksvg.SvgImage(file="C:/Users/300ju/Desktop/DxPackage/linedraw/output/merged.svg")
    ...
    # save original image to svg
    linedraw.sketchOriginal(image)
...
def drawBox(type):
    ...
    if(type=="robot"):
        ...
        coordAr = windowQT.comicBox(45000,85000,80000,40000,toolType)
        return(coordAr)
    else:
