...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Home_pos = tk.Button(top)
        self.Home_pos.place(relx=0.028, rely=0.546, height=31, width=60)
        self.Home_pos.configure(activebackground="#ececec")
        self.Home_pos.configure(activeforeground="#000000")
        self.Home_pos.configure(background="#d9d9d9")
        self.Home_pos.configure(disabledforeground="#a3a3a3")
        self.Home_pos.configure(foreground="#000000")
        self.Home_pos.configure(highlightbackground="#d9d9d9")
        self.Home_pos.configure(highlightcolor="black")
        self.Home_pos.configure(pady="0")
        self.Home_pos.configure(text='Home')
        ...
        self.Home_pos.bind("<Button-1>", self.start_move)
        self.Home_pos.bind("<ButtonRelease-1>", self.start_move)
    ...
    def start_move(self, event):
        ...
        if(axis=='Home'):
            ...
            self.robot.move(None, FS100.MOVE_TYPE_JOINT_ABSOLUTE_POS, 
        ...
        #self.robot.one_move(FS100.MOVE_TYPE_JOINT_ABSOLUTE_POS,
        ...
        if FS100.ERROR_SUCCESS == self.robot.one_move(FS100.MOVE_TYPE_LINEAR_INCREMENTAL_POS,
                                                      #FS100.MOVE_COORDINATE_SYSTEM_ROBOT, speed_class, speed, pos):
                                                      FS100.MOVE_COORDINATE_SYSTEM_BASE, speed_class, speed, pos):
